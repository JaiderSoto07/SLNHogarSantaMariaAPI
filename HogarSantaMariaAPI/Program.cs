...
builder.Services.AddScoped<ITurnoLavanderiaService, TurnoLavanderiaService>();
builder.Services.AddScoped<ISancionService, SancionService>();
builder.Services.AddScoped<ISolicitudMantenimientoService, SolicitudMantenimientoService>();
